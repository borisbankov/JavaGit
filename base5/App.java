...
public class App extends javax.swing.JFrame {
    ...
    public App() {
        initComponents();
        jPanel1.add(label);
        label.setText("Nadpis");
        label.setSize(50,50);
        x = jPanel1.getWidth()/2 - label.getWidth()/2;
        y = jPanel1.getHeight()/2 - label.getHeight()/2;
        label.setLocation(x, y);
        
        jRadioButton1.setActionCommand("5");        
        jRadioButton2.setActionCommand("15");
        jRadioButton3.setActionCommand("25");

        String s = "axaabc-12a-ha5a";
        int counter = 0;
...
//        System.out.println(s.split("a").length - 1);
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Обърни посоката");

        jToggleButton1.setText("Рестарторай/Възобнови");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(buttonGroup1.getSelection() != null){  
            stepX = Integer.parseInt(buttonGroup1.getSelection().getActionCommand());
        }
        if(jCheckBox1.isSelected()){
            label.setLocation(label.getX() + stepX, label.getY());
            x = x + stepX;
        } else {
            label.setLocation(label.getX() - stepX, label.getY());
            x = x - stepX;
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        if(jToggleButton1.isSelected()){
            label.setLocation(jPanel1.getWidth()/2 - label.getWidth()/2, 
                          jPanel1.getHeight()/2 - label.getHeight()/2);
        } else {
            label.setLocation(x, y);
        }
